...
The latest release contains only **Playing to win**, the complete 3–1 review under `football-0.8`. All eight live assets match the checked build; the previous keeper review and six earlier public/excerpt URLs return 404. [Slice 26](slices/26-PLAYING-TO-WIN-RELEASE.md) records this deployment. Keep release progress in these docs; the main README remains evergreen.
