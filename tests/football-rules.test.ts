...
describe('contested play and match completion', () => {
  ...
  it('runs and replays a complete four-minute scripted baseline with both halves and no fabricated completion', () => {
    ...
    expect(final.playingTicks).toBe(240 * TICK_RATE);
